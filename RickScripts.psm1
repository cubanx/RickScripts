...
# Export functions
Export-ModuleMember -Function Switch-Branch, Switch-MergeRequest, Remove-LocalBranchesThatAreMerged, Clear-NodeModules, Open-ProjectFolder, New-MergeRequest

# Export aliases
Export-ModuleMember -Alias sb, smr, rlb, cnm, opf, nmr
